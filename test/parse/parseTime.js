...
test("Should allow to omit MM and SS units in both formats", t => {
  ...
  t.deepEqual(parseTime("01:00am"), ["01", "00", undefined, "am"])
  t.deepEqual(parseTime("00:00"), ["00", "00", undefined])

  t.deepEqual(parseTime("01am"), ["01", undefined, undefined, "am"])
  t.deepEqual(parseTime("00"), ["00", undefined, undefined])
})
